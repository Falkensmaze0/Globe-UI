...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/globeui)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/globeui
```

A live public deployment of this template is available at [https://globeui.templates.workers.dev](https://globeui.templates.workers.dev)
